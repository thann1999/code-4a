  ...
  return (
    <div className="w-64">
      <div className="w-full justify-between flex items-center mb-3">
        <Typography.Title level={5}>Cài đặt chung</Typography.Title>
        <Icon
      ...
      <Row gutter={[16, 16]}>
        <Col span={24}>
          <div className="rounded-lg bg-bg-light dark:bg-bg-dark h-32 hover:bg-bg-light-hover relative p-4">
            ...
            <Typography className="pt-12">Chủ đề trang web</Typography>
          </div>
        </Col>
        ...
        <Col span={24}>
          <div className="rounded-lg bg-bg-light dark:bg-bg-dark h-32 hover:bg-bg-light-hover relative p-4">
            <Select
              ...
              defaultValue={selectedLanguage?.value || Language.VI}
            >
            ...
            <Typography className="pt-12">Chọn ngôn ngữ</Typography>
          </div>
        </Col>
      </Row>
    </div>
